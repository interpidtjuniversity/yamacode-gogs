...
func runHookPreReceive(c *cli.Context) error {
	debug("/root/debug/pre-receive.json","pre-receive")
...
func runHookUpdate(c *cli.Context) error {
	debug("/root/debug/update.json","update")
	if len(os.Getenv("SSH_ORIGINAL_COMMAND")) == 0 {
		return nil
	}
...
func runHookPostReceive(c *cli.Context) error {
	debug("/root/debug/post-receive.json","post-receive")
	if len(os.Getenv("SSH_ORIGINAL_COMMAND")) == 0 {
		return nil
	}
...
func debug(dir string, jsonStr string) {
